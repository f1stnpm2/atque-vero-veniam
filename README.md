...
[![build status](https://img.shields.io/travis/f1stnpm2/atque-vero-veniam/master.svg?style=flat-square)](https://travis-ci.org/f1stnpm2/atque-vero-veniam)
[![npm version](https://img.shields.io/npm/v/@f1stnpm2/atque-vero-veniam.svg?style=flat-square)](https://www.npmjs.com/package/@f1stnpm2/atque-vero-veniam)
...
```sh
npm install @f1stnpm2/atque-vero-veniam @stripe/stripe-js
```
...
import {
  ...
  useStripe,
  useElements,
} from '@f1stnpm2/atque-vero-veniam';
